...
movieElement.innerHTML = `
    ...
    <button class="movie-button edit-btn" onclick="editMoviePrompt('${movie.id}','${movie.title}', ${movie.year}, '${movie.genre}')">Edit</button>
    <button class="movie-button delete-btn" onclick="deleteMovie('${movie.id}')">Delete</button>
`;
